...
| `catan-scenario-art.svg` | 新增：原创布匹、堡垒、战舰与五张奇观插画；与页面内嵌图案同步 |
...
世外部落图例澄清：更新 `catan-board.js`、`catan-scenario-ui.js`、`catan-scenario-maps.js`、`catan.js`、`catan.html`、`catan.css` 及 `catan-scenario-ui-test.js`。外岛中央去掉资源图标，改为无产出、不可建村标注；海岸奖励显示 +1／发展卡／2:1 或 3:1 海港并连接到领取边。点击外岛、礼物、海盗可打开只读说明，不触发建设。六个海港的领取与放置要求合并说明，区分资源图标与实际资源卡。保持原画风与移动端滚动规则，完整上传包仍为 81 文件。
