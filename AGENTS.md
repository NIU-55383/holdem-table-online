...
- Human auto-play is opt-in only. Each new seat defaults to idleAuto=false; room management offers a personal checkbox for 120-second idle auto-play, never a host-forced room-wide setting. Only opted-in required connected human actors get deadlines and a warning in the final 20 seconds. A valid action or stay acknowledgement resets their deadline; chat/profile/reactions do not. Disabling the option clears the deadline and stops current auto-play. Explicit Start auto and Stop auto remain available. Vacancies suspend deadlines; replacements never inherit the former occupant's opt-in. Disconnecting or leaving must not silently enable auto-play or auto-fold a human; wait for their return or host-managed replacement. Preserve green online presence for connected auto-playing humans.
